...
internal sealed class InventoryServiceFactory(
    string postgresConnectionString)
    : WebApplicationFactory<InventoryServiceAssemblyMarker>
{
        ...
        IWebHostBuilder builder)
    {
        ...
        {
            RemoveInventoryHostedServices(services);
    ...
    private static void RemoveInventoryHostedServices(
            ...
            .Where(
                descriptor =>
                    ...
                    descriptor.ImplementationType
                        ?.Assembly ==
                    typeof(InventoryServiceAssemblyMarker)
                        .Assembly)
            .ToArray();
