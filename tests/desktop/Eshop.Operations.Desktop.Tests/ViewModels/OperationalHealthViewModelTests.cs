...
public sealed class OperationalHealthViewModelTests
{
    ...
    public async Task RefreshHealthMapsHealthyResponse()
    {
        ...
        [
            new("Catalog", "Healthy", 12),
            new("Basket", "Healthy", 8),
            new("Orders", "Healthy", 15),
            new("Inventory", "Healthy", 10),
            new("Payments", "Healthy", 11),
            new("Notifications", "Healthy", 9)
        ];
        ...
        OperationalHealthViewModel viewModel =
            CreateViewModel(
                new OperationalHealthResponseDto(
                    ...
                    DateTimeOffset.UtcNow,
                    [
                        new("Orders", "Healthy", 12),
                        new("Payments", "Unavailable", 2001)
                    ]));
