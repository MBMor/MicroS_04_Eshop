...
| 04. Catalog | public queries, mutations, validation/SKU, price contract, direct service boundary | TECH-07 service boundary accepted in Main and Release evidence |
...
All 198 logical tests remain governed in the accepted TECH-08 baseline. QA-03 defines authoritative primary ownership `PR=77`, `Main=102`, `Nightly=19` plus `Release=17 overlap`; Main is cumulative at 179 selectors. Main publishes `12/24/3/4` and governed Release publishes 9 TestIntents over 26 edges; Main CI #66 and Release #4 accepted those contracts.
