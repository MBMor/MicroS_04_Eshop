...
namespace OrdersService.Data.Migrations
{
    ...
    [Migration("20260728154540_AddOrderIdempotency")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrdersService.Domain.OrderIdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("CustomerId", "Operation", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ux_order_idempotency_customer_operation_key");
            ...
            modelBuilder.Entity("OrdersService.Domain.OrderStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("OrdersService.Domain.OrderIdempotencyRecord", b =>
                {
                    b.HasOne("OrdersService.Domain.Order", null)
                        .WithOne()
                        .HasForeignKey("OrdersService.Domain.OrderIdempotencyRecord", "OrderId")
